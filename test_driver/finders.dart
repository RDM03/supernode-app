...
Map f = {
  'homeMXCLogin': find.byValueKey('homeMXCLogin'),
  'homeMXCSignup': find.byValueKey('homeMXCSignup'),
  'homeMXCDemo': find.byValueKey('homeMXCDemo'),
  'homeDHXImport': find.byValueKey('homeMXCLogin'),
  'homeDHXCreate': find.byValueKey('homeMXCLogin'),
  'logoFinder': find.byValueKey('homeLogo'),
  'Korea': find.byValueKey('Korea'),
  'China': find.byValueKey('China'),
  'Europe': find.byValueKey('Europe'),
  'Oceania': find.byValueKey('Oceania'),
  'Asia': find.byValueKey('Asia'),
  'America': find.byValueKey('America'),
  'Test': find.byValueKey('Test'),

  'loginFinder': find.byValueKey('homeLogin'),
  'menuFinder': find.byValueKey('homeSupernodeMenu'),
  'homeSupernodeLogin': find.byValueKey('homeSupernodeLogin'),
  ...
  'homeMXCCurrentBalance': find.byValueKey('homeMXCCurrentBalance'),
  'homeStakedAmount': find.byValueKey('homeMXCStakedAmount'),
  'homeStakingRevenue': find.byValueKey('homeMXCTotalRevenue'),
