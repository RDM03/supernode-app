...
class InfoWindow {
  ...
  /// displayed.
  ///
  /// The iconImage point is specified in normalized coordinates: An anchor of
  /// (0.0, 0.0) means the top left corner of the iconImage. An anchor
  /// of (1.0, 1.0) means the bottom right corner of the iconImage.
  final Offset anchor;
...
class Marker {
  ...
  /// The icon iconImage point that will be placed at the [position] of the marker.
  ///
  /// The iconImage point is specified in normalized coordinates: An anchor of
  /// (0.0, 0.0) means the top left corner of the iconImage. An anchor
  /// of (1.0, 1.0) means the bottom right corner of the iconImage.
  ...
  /// Rotation of the marker iconImage in degrees clockwise from the [anchor] point.
  ...
  Marker copyWith({
    ...
    return Marker(
      markerId: markerId,
      iconImage: iconImageParam ?? iconImage,
  ...
  @override
  String toString() {
    return 'Marker{markerId: $markerId, iconImage: $iconImage, alpha: $alpha, anchor: $anchor, '
