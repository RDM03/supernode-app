...
///
/// (See [MethodChannelMapboxFlutter.onCameraMoveStarted], for example)
///
...
class CameraMoveEvent extends MapEvent<CenterPosition> {
  ...
  CameraMoveEvent(int mapId, CenterPosition position) : super(mapId, position);
}
