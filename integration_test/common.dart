...
final String mxcTestDhxAddress =
    '5FErYFbRFsQJyMVP4sMYCpFih6nYY4B1pSYKR2eB4TeqZ13J';
final String shopM2proURL =
...
Future<void> pumpAndTap(WidgetTester tester, String key,
    {int tapCount: 1, bool firstWidget: false}) async {
  Finder finder = null;
...
Future<void> pumpAndEnterText(WidgetTester tester, String key, String value,
    {int tapCount: 1}) async {
