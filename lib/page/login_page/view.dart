            ...
            child: Stack(
              ...
              children: <Widget>[
                          ...
                          children: <Widget>[
                              ...
                              child: Column(children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: TextFieldWithTitle(
                                    title:
                                        FlutterI18n.translate(_ctx, 'password'),
                                    hint: FlutterI18n.translate(
                                        _ctx, 'password_hint'),
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                GestureDetector(
                                  onTap: () => dispatch(LoginActionCreator
                            ...
                            PrimaryButton(
                                ...
                                buttonTitle:
                                    FlutterI18n.translate(_ctx, 'login'),
                                minHeight: s(46),
                                minWidget: double.infinity),
                            Container(
                              margin: EdgeInsets.only(
                                  top: s(28.5), bottom: s(17.5)),
                              height: s(1),
                              color: darkBackground,
                            ),
                            Text(
                ...
                if (state.showSuperNodeList)
                  GestureDetector(
                    onTap: () => dispatch(
                        LoginActionCreator.superNodeListVisible(false)),
                    child: Container(
                ...
                AnimatedPositioned(
                  ...
                  left:
                      state.showSuperNodeList ? 0 : -ScreenUtil.instance.width,
                  child: Container(
