...
Widget buildView(
    DepositState state, Dispatch dispatch, ViewService viewService) {
  var _ctx = viewService.context;

  return pageFrame(context: viewService.context, children: [
    pageNavBar(FlutterI18n.translate(_ctx, 'top_up'),
    ...
    submitButton(FlutterI18n.translate(_ctx, 'copy_address'),
        onPressed: () => dispatch(DepositActionCreator.copy())),
    paragraph(FlutterI18n.translate(_ctx, 'send_deposit_address')),
    introduction(FlutterI18n.translate(_ctx, 'send_coin_tip'), top: 5),
