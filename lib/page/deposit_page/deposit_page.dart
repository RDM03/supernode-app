      ...
      body: BlocBuilder<DepositCubit, DepositState>(
        ...
        builder: (ctx, s) {
          return PageBody(children: [
            smallColumnSpacer(),
            Text(FlutterI18n.translate(context, 'send_deposit_address').replaceFirst('{0}', widget.tkn.name), style: kBigFontOfBlack),
            Text(FlutterI18n.translate(context, 'send_coin_tip').replaceFirst('{0}', widget.tkn.name), style: kBigFontOfBlack),
            Text(FlutterI18n.translate(context, 'deposit_confirm_tip').replaceFirst('{0}', widget.tkn.name), style: kBigFontOfBlack),
            bigColumnSpacer(),
            Center(
                child:
                Container(
