        ...
        panelFrame(
          child: Column(
            children: <Widget>[
              ...
              // Divider(),
              listItem(
                FlutterI18n.translate(_ctx,'language'),
                onTap: () => dispatch(SettingsActionCreator.onSettings('language'))
              ),
              Divider(),
              listItem(
                FlutterI18n.translate(_ctx,'about'),
                onTap: () => dispatch(SettingsActionCreator.onSettings('about'))
              ),
              Divider(),
              listItem(
                FlutterI18n.translate(_ctx,'logout'),
                trailing: Text(''),
                onTap: () => dispatch(SettingsActionCreator.onSettings('logout'))
              ),
            ],
          )
        )
