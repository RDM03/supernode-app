...
List<GatewayItem> parseGateways(dynamic gatewaysResponse,
    List<MinerHealthResponse> listMinersHealth, String orgId) {
  ...
  if (tempGatewaysList.length > 0) {
    for (int index = 0; index < tempGatewaysList.length; index++) {
      ...
      tempGatewaysList[index]['reseller'] =
          (tempGatewaysList[index]['organizationID'] != orgId);
