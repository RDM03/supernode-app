  ...
  Widget build(BuildContext context) {
    return MultiBlocListener(
      listeners: [
        ...
        BlocListener<MinerCubit, MinerState>(
          listenWhen: (a, b) => a.isRegisterResellerSuccess != b.isRegisterResellerSuccess,
            ...
            if (state.addMinerFlowStep == AddMinerFlow.setting) {
              Navigator.push(context,
                route((_) => BlocProvider(
                    ...
                    child: MinerProfileSettingPage(serialNumer: state.serialNumber)
                  )
                )
              );
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    FlutterI18n.translate(context, 'scan_qrcode'),//'Scan QR to add Miner'),
                ...
                Expanded(
                  child: Form(
                    ...
                    child: BlocBuilder<MinerCubit, MinerState>(
                      buildWhen: (a, b) => a.textColor != b.textColor,
                      builder: (ctx, state) {
                        return TextFormField(
                          controller: serialNumberCtrl,
                          textInputAction: TextInputAction.next,
                          validator: (value) => Reg.onNotEmpty(ctx, value),
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            hintText:  FlutterI18n.translate(context, 'input_serial_number')//'Manually add serial number',
                          ),
                          style: MiddleFontOfColor(color: state.textColor),
                          onChanged: (value) => ctx.read<MinerCubit>().changeColor(value)
                        );
                      }
                    )
                  )
          ...
          BlocBuilder<GatewayCubit, GatewayState>(
            ...
            builder: (ctx, state) => Visibility(
              ...
              child: DDBoxWithShadow(
                ...
                itemBuilder: (BuildContext ctx, GatewayItem state, int index) =>
                  Slidable(
        ...
        floatingActionButton: Container(
          ...
          child: PrimaryButton(
            ...
            onTap: () async {
              ...
              await context.read<MinerCubit>().submitSerialNumber(serialNumberCtrl.text);
            }
          ),
        )
      )
