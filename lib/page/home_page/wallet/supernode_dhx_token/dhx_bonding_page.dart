              ...
              child: Column(
                children: [
                      ...
                      Flexible(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            //Text(FlutterI18n.translate(context, 'bond_dhx_instruction_1'), style: kMiddleFontOfBlack),
                            //Text(FlutterI18n.translate(context, 'bond_dhx_instruction_2'), style: kMiddleFontOfBlack),
                          ]),
                      )
                    ]),
                  bigColumnSpacer(),
                  ...
                  PrimaryButton(
                      ...
                      onTap: () => context.read<SupernodeDhxCubit>().bondConfirm(ctrl.text.trim()),
