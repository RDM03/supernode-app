...
Widget buildView(
      ...
      child: panelFrame(
        ...
        child: Column(children: [
          Container(
            ...
            child: Row(children: [
              Image.asset(
                  (tkn == Token.MXC) ? AppImages.logoMXC : AppImages.logoDHX),
              SizedBox(width: s(3)),
              ...
              state.expandedView
                  ? (tkn == Token.DHX)
                      ? PrimaryButton(
                          ...
                          buttonTitle:
                              FlutterI18n.translate(_ctx, 'simulate_mining'),
                          onTap: () => Navigator.pushNamed(
                                  _ctx, 'mining_simulator_page', arguments: {
                                'isDemo': state.isDemo,
          ...
          titleDetailRow(
              loading: !state.loadingMap.contains((tkn == Token.MXC)
                  ? 'balance'
                  : LocalStorageDao.balanceDHXKey),
              name: FlutterI18n.translate(_ctx, 'current_balance'),
              value: Tools.priceFormat(
                  (tkn == Token.MXC) ? state.balance : state.balanceDHX),
          ...
          (tkn == Token.DHX)
              ...
              : SizedBox(),
          titleDetailRow(
              loading: (tkn == Token.MXC) &&
                  !state.loadingMap.contains('stakedAmount'),
              name: FlutterI18n.translate(_ctx, 'staked_amount'),
              value: (tkn == Token.MXC)
                  ? Tools.priceFormat(state.stakedAmount)
                  : FlutterI18n.translate(_ctx, 'not_available'),
              token: (tkn == Token.MXC) ? "MXC" : ""),
          titleDetailRow(
              loading: !state.loadingMap.contains((tkn == Token.MXC)
                  ? 'totalRevenue'
                  : LocalStorageDao.lockedAmountKey),
              name: FlutterI18n.translate(_ctx, 'total_revenue'),
              value: Tools.priceFormat(
                  (tkn == Token.MXC)
                      ? state.totalRevenue
                      : state.totalRevenueDHX,
                  range: 2),
              token: (tkn == Token.MXC) ? "MXC" : "DHX")
        ]),
      )));
          ...
          child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(FlutterI18n.translate(_ctx, 'add_new_token'),
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(FlutterI18n.translate(_ctx, "mining"),
                  style: kBigBoldFontOfBlack),
              Spacer(),
              Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  Text(FlutterI18n.translate(_ctx, "daily_mining_capacity"),
                      style: kSmallFontOfBlack),
                  SizedBox(height: s(5)),
                  Text('5000 DHX',
                      style: MiddleFontOfColor(color: colorToken[Token.DHX])),
                ],
              ),
            ]),
          ),
          ...
          Row(children: [
            ...
            Column(children: [
              ...
              Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(FlutterI18n.translate(_ctx, 'm2pro_miner'),
            ...
            Column(children: [
              !state.loadingMap.contains(LocalStorageDao.lockedAmountKey)
                  ? loadingFlash(
                      child: Text(Tools.numberRounded(state.mPower),
                          style: kPrimaryBigFontOfBlack))
                  : Text(Tools.numberRounded(state.mPower),
              ...
              Container(
                  ...
                  child: Padding(
                      ...
                      child: Stack(
                          ...
                          children: [
                            Text(FlutterI18n.translate(_ctx, 'm2pro_miner'),
                                style: TextStyle(
                                    color: colorToken[Token.DHX],
                                    fontFamily: "Roboto",
                                    fontSize:
                                        14)), // invisible - sets width for Container
                            Text(FlutterI18n.translate(_ctx, 'mpower'),
                                style: kSecondaryButtonOfWhite)
                          ])))
            ]),
            Spacer()
          ...
          titleDetailRow(
              loading:
                  !state.loadingMap.contains(LocalStorageDao.miningPowerKey),
        ...
        child: ListView(children: [
          Padding(
            ...
            child: Row(children: [
              ...
              CircleButton(
                  icon: Icon(Icons.add,
                      color: (t == Token.DHX) ? Colors.grey : colorToken[t]),
              ...
              Spacer(),
              CircleButton(
                  icon: Image.asset(AppImages.iconMine, color: colorToken[t]),
                  label: FlutterI18n.translate(
                      _ctx, (t == Token.MXC) ? 'stake' : 'mine'),
                  onTap: () => (t == Token.DHX)
                      ? _showMineDXHDialog(_ctx, state.isDemo)
                      : _showStakeDialog(_ctx, dispatch)),
              Spacer(),
              (t == Token.DHX)
                  ? CircleButton(
                      icon: Image.asset(AppImages.iconCouncil,
                          color: (state.stakeDHXList == [])
                              ? Colors.grey
                              : colorToken[t]),
                      label: FlutterI18n.translate(_ctx, 'council'),
                      onTap: () {
                        Set<String> argJoinedCouncils = state.stakeDHXList
                            .where((e) => !e.historyEntity.closed)
                            .map((e) => e.historyEntity.councilId)
                            .toSet();
                        (state.stakeDHXList == [])
                            ? "do nothing"
                            : Navigator.pushNamed(_ctx, 'list_councils_page',
                                arguments: {
                                    'isDemo': state.isDemo,
          ...
          Padding(
            ...
            child: CupertinoSlidingSegmentedControl(
                ...
                onValueChanged: (tabIndex) =>
                    dispatch(WalletActionCreator.onTab(tabIndex)),
                  ...
                  0: Text(
                      FlutterI18n.translate(
                          ...
                          (t == Token.MXC)
                              ...
                              : "mining_income"),
                      style: TextStyle(
                          color: (state.activeTabToken[t] == 0)
                              ? Colors.white
                              : Colors.grey)),
                  1: Text(
                      FlutterI18n.translate(
                          ...
                          (t == Token.MXC)
                              ...
                              : 'transaction_history'),
                      style: TextStyle(
                          color: (state.activeTabToken[t] == 1)
                              ? Colors.white
                              : Colors.grey))
                }),
          ),
          ...
          Visibility(
            ...
            child: secondaryButtons(
                ...
                onTap2: () =>
                    dispatch(WalletActionCreator.onFilter('WITHDRAW')),
          ...
          Visibility(
            ...
            child: secondaryButtons(
                buttonLabel1:
                    FlutterI18n.translate(_ctx, 'stake').toUpperCase(),
                buttonLabel2:
  ...
  Widget expandedView() => Stack(
        ...
        children: [
          PageView(
              controller:
                  PageController(initialPage: state.selectedToken.index),
              onPageChanged: (val) =>
                  dispatch(WalletActionCreator.selectToken(Token.values[val])),
