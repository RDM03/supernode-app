...
class ReorderableListViewCustom extends StatefulWidget {
  ...
  @override
  _ReorderableListViewStateCustom createState() =>
      _ReorderableListViewStateCustom();
}
...
class _ReorderableListViewStateCustom extends State<ReorderableListViewCustom> {
      ...
      Widget child = LongPressDraggable<Key>(
        ...
        feedback: Container(
          ...
          constraints: constraints.copyWith(
            maxWidth: constraints.maxWidth - widget.padding.right * 2,
            minWidth: constraints.minWidth - widget.padding.right * 2,
          ),
