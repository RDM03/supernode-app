...
Widget buildView(ChangePasswordState state, Dispatch dispatch, ViewService viewService) {
          ...
          children: <Widget>[
            ...
            TextFieldWithTitle(
              ...
              suffixChild: IconButton(
                icon: Icon( state.isObscureOldPWDText ? Icons.visibility_off : Icons.visibility),
                onPressed: () => dispatch(ChangePasswordActionCreator.isObscureOldPWDText())
              ),
            ),
            smallColumnSpacer(),
            TextFieldWithTitle(
              ...
              suffixChild: IconButton(
                icon: Icon( state.isObscureNewPWDText ? Icons.visibility_off : Icons.visibility),
                onPressed: () => dispatch(ChangePasswordActionCreator.isObscureNewPWDText())
              ),
            ),
            smallColumnSpacer(),
            TextFieldWithTitle(
              ...
              suffixChild: IconButton(
                icon: Icon( state.isObscureConPWDText ? Icons.visibility_off : Icons.visibility),
                onPressed: () => dispatch(ChangePasswordActionCreator.isObscureConPWDText())
              ),
            ),
          ]
        )
