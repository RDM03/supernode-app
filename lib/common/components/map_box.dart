...
class _MapBoxWidgetState extends State<MapBoxWidget> {
  ...
  Widget _buildMapView() {
    return Stack(
      children: <Widget>[
        MapboxMap(
          onMapClick: (point, coordinates) => widget.onTap(coordinates),
          initialCameraPosition: CameraPosition(target: widget.myLatLng),
  ...
  Widget _buildMyLocationIcon() {
    return Positioned(
      bottom:
          widget.isFullScreen ? 20 + _mediaData.padding.bottom + 40 + 10 : 205,
      right: 20,
      width: 40,
      height: 40,
      child: Container(
