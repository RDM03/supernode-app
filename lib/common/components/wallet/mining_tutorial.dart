...
class MiningTutorial extends StatefulWidget {
    ...
    return Container(
        ...
        child: RichText(
            ...
            text: TextSpan(children: [
              TextSpan(
                  text: FlutterI18n.translate(ctx, "tutorial_bubble"),
                  style: kBigFontOfBlack),
              TextSpan(
                  text: FlutterI18n.translate(ctx, "tutorial_bubble2"),
  ...
  Widget _page1(BuildContext ctx) {
    return _pageBase([
      Text(FlutterI18n.translate(ctx, "tutorial_pg1_title"),
          style: kPrimaryBigFontOfBlack),
      SizedBox(height: s(10)),
      Text(FlutterI18n.translate(ctx, "tutorial_pg1_text"),
          style: kBigFontOfBlack),
  ...
  Widget _page3(BuildContext ctx) {
    return _pageBase([
      Text(FlutterI18n.translate(ctx, "tutorial_pg3_title"),
          style: kPrimaryBigFontOfBlack),
      SizedBox(height: s(10)),
      Text(FlutterI18n.translate(ctx, "tutorial_pg3_text"),
          style: kBigFontOfBlack),
      SizedBox(height: s(30)),
      Row(children: [
        Container(
  ...
  Widget _page4(BuildContext ctx) {
    return _pageBase([
      Text(FlutterI18n.translate(ctx, "tutorial_pg4_title"),
          style: kPrimaryBigFontOfBlack),
      SizedBox(height: s(10)),
      Text(FlutterI18n.translate(ctx, "tutorial_pg4_text"),
          style: kBigFontOfBlack),
      SizedBox(height: 40),
      Container(
          decoration: BoxDecoration(
          ...
          child: Row(
            children: [
              Container(
                  ...
                  child:
                      Image.asset(AppImages.iconCouncil, color: Colors.white)),
              Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Text('MatchX (Germany)'),
                      SizedBox(height: 5),
                      Text(FlutterI18n.translate(ctx, "latest_mpower") +
                          ' : 5000000'),
                    ]),
              )
            ],
          )),
      submitButton(FlutterI18n.translate(ctx, "tutorial_pg4_button"),
          top: 50, onPressed: () => Navigator.pop(ctx)),
      SizedBox(height: s(15)),
      _bubble(ctx),
      SizedBox(height: 25)
    ]);
